...
const randomAddressSchema = zod_1.z.object({
    location: zod_1.z.object({
        city: zod_1.z.string(),
        postcode: zod_1.z.number(),
    }),
});
// Random Login Schema
const randomLoginSchema = zod_1.z.object({
    results: zod_1.z.array(zod_1.z.object({
        login: zod_1.z.object({
            username: zod_1.z.string(),
        }),
        registered: zod_1.z.object({
            date: zod_1.z.string(),
        }),
    })),
});
//SECTION - Functions
// Validation
const validateUser = (schema, inputData) => {
...
// Fetch API data
const fetchData = async (url, schema) => {
    try {
